...
function readSqliteValue(key: string): string | null {
  try {
...
function writeSqliteValue(key: string, value: string): boolean {
  try {
...
function writeKeychainValue(service: string, value: string): boolean {
  try {
...
function persistAccessToken(source: AuthSource, accessToken: string): void {
  if (source === 'keychain') {
